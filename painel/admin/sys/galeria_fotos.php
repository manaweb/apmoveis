...
// -------------------------------------------------------------------------------
?>
<fieldset class="adicionar"><legend>O Evento</legend>
<table>
  ...
  <img src="../../img.php?img=arquivos/galeria/<?=$dados2['codigo'];?>/capa.jpg&x=100&y=100&corta=0" />
  </td></tr>
</table>
</fieldset>
...
<table class="viewCampos" id="uploadFtp" style="display:none;">
  ...
  <input maxlength="25" type="hidden" name="id_galeria" value="<?=$dados2['id_galeria'];?>" >
  <tr><td>Baixar as fotos de <font face="Courier New, Courier, monospace">/arquivos/ftp/</font></td></tr>
...
<table >
  ...
  ?>
		<td width="80" align="center">
        	<label><input value="1" type="checkbox" id="foto<?=$foto['id_foto'];?>" name="foto[<?=$foto['id_foto'];?>]" style="border:0"><img alt="<?=(int)$foto['contador'];?> views" src="../../arquivos/galeria/<?=$dados2['codigo'];?>/miniaturas/<?=$foto['imagem'];?>" /></label><br />
