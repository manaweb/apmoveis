<? 
	...
	if ($_GET['faz']=="dados") {
		...
		# Dados
		$dados = array( 'id_evento'=>$id_evento, 'titulo'=>$titulo, 'data'=>dataDMY_YMD($data), 'descricao'=>$descricao);
		...
		if ($$Config['id']>0) {
			...
			$dados['id_evento']=$_SESSION['Admin']['id_evento'];
			db_executa($Config['tabela'],$dados);
			
			# Cadastrar novo endereço
			$dados_end = array('id_evento'=>$id_evento);
